...
4. **Use the Orthographic checkbox** on the Camera node as the standard end-to-end test: select Camera in scene tree, toggle the Orthographic checkbox in the Node Inspector, and verify the `setPinValueByName` (or equivalent) call appears in the log files.
