      ...
      {sceneNode.type && (
        <div
          style={{
            ...
            bottom: -1,
            width: 26,
            backgroundColor: 'var(--octane-border)',
            borderRadius: '8px 0 0 8px',
            borderTop: selected ? '2px solid var(--octane-accent-yellow)' : '1px solid var(--octane-border)',
            borderBottom: selected ? '2px solid var(--octane-accent-yellow)' : '1px solid var(--octane-border)',
            borderLeft: selected ? '2px solid var(--octane-accent-yellow)' : '1px solid var(--octane-border)',
            borderRight: 'none',
            display: 'flex',
            alignItems: 'center',
