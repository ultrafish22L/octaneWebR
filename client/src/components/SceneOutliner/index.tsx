...
// Virtual scrolling row component (react-window v2 List API)
// Custom props passed via rowProps
...
// React-window v2 rowComponent must be a function (not React.FC)
// It receives built-in props (ariaAttributes, index, style) + custom props from rowProps
