...
| 42  | **`execute_batch` tool**                      | Hard       | gRPC overhead is 1.4s vs 300s Claude thinking. Batch multiple operations in one tool call to reduce round-trips. See `perf_execute_batch.md`.                                                                                 |
